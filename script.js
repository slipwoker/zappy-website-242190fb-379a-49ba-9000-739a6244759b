    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Pluto Steed Alliance uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '242190fb-379a-49ba-9000-739a6244759b',
                    name: data.name || '',
                    email: data.email || '',
